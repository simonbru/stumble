...
module.exports = class IO {
  ...
  establish (lines) {
    ...
    if (lines.input) {
      if (lines.inputTargets != null) {
        this.input = this.parent.client.inputStreamForUser(
          lines.inputTargets, lines.inputOptions
        )
      } else {
        this.input = this.parent.client.connection.inputStream(
          lines.inputOptions
        );
      }
    }
