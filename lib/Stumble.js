...
const CustomMumbleInputStream = require('./MumbleInputStream');
  ...
  connect () {
    ...
    Mumble.connect(addr, clone(this.__mumbleopts), (error, client) => {
      if (error) {
        ...
        // Monkey-patch inputStream method to use our custom
        // implementation of MumbleInputStream
        client.connection.inputStream = function( options ) {
          var stream = new CustomMumbleInputStream( this, options );
          return stream;
        };
